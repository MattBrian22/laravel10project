                ...
                <div class="team-profiles">
                    <div class="team-role">
                        <div class="team-images">
                            <img src="{{ asset('assets/sources/img_female.png') }}"  alt="female">
                        </div>
                    ...
                    <div class="team-role">
                        <div class="team-images">
                            <img src="{{ asset('assets/sources/img_male.png') }}" alt="male">
                        </div>
                    ...
                    <div class="team-role">
                        <div class="team-images">
                            <img src="{{ asset('assets/sources/img_female.png') }}"  alt="girl">
                        </div>
                        <div class="role-explain">
